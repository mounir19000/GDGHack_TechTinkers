...
const AdminPage = () => {
  ...
  const user = { username: "Admin", isInterne: true };
    ...
    <>
      <div className="flex flex-col bg-[#011225]">
        ...
        <div className="flex flex-col justify-center items-center px-16 bg-[#011225]">
          ...
          <div className="min-w-full flex flex-row justify-between items-center my-4">
            ...
            <div className="flex items-center space-x-2">
              ...
              <Link
                to="/add-event"
                className="text-white font-bold text-xl hover:cursor-pointer"
              >
                + Add Event
              </Link>
